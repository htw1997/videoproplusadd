...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" id="formSimple">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerDesc" value="${speaker.speakerDesc}"
                       placeholder="简介">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <form id="uploadForm" enctype="multipart/form-data" method="post">
                    <input type="file" name="headImg" id="uploadImgInput" onchange="fileUploadSpeaker()"/>
                </form>

                <div id="photo"></div>

                <input type="hidden" id="headImgUrl" name="headImgUrl" class="form-control"
                       value="${speaker.headImgUrl}" placeholder="具体的url">
            </div>
        </div>
