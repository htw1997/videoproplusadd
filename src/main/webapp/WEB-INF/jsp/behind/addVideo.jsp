    ...
    <script type="text/javascript">
        ...
        function validateInput2(obj) {
            ...
            if (!/^http:\/\/[a-z]+\.[a-z0-9]+\.[a-z]{2,}$/.test(value)) {
                alert("该输入不是一个网址，例如：http://www.alibaba.cn");
            }
        }
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" id="formSimple">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <c:if test="${empty video.time}">
                    <input type="text" class="form-control" name="time" placeholder="精确到毫秒（正整数）"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" onblur="validateInput2(this)" name="videoUrl" class="form-control"
                       value="${video.videoUrl}" placeholder="具体的url">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="hidden" id="imageUrl" name="videoImageUrl" class="form-control" value="${video.videoImageUrl}"
                       placeholder="具体的url">
            </div>
        </div>
